...
const MenWatchesPage = () => {
    ...
    const filteredProducts = useMemo(() => {
        let result = products.filter((p) => p.gender === "men");
    ...
    const menProductsCount = products.filter((p) => p.gender === "men").length;
        ...
        <main className="min-h-screen pt-24 pb-16 bg-background">
            <div className="container mx-auto px-4">
                ...
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-8 text-right">
                    <h1 className="font-display text-4xl font-bold mb-2">ساعات رجالية</h1>
                    <p className="text-muted-foreground">اكتشف تشكيلتنا الفاخرة من الساعات الرجالية العالمية.</p>
                </motion.div>
                ...
                <div className="flex gap-8">
                    ...
                    <div className="flex-1">
                        <p className="text-muted-foreground mb-6 text-sm">
                            عرض <span className="text-foreground font-bold">{filteredProducts.length}</span> من <span className="text-foreground font-bold">{menProductsCount}</span> منتج
                        </p>
